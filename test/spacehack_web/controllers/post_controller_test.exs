defmodule SpacehackWeb.PostControllerTest do
  use SpacehackWeb.ConnCase

  alias Spacehack.Posts

  @create_attrs %{b: "some b", body: "some body", data: "some data", date: ~D[2010-04-17], lat: 120.5, lng: 120.5, title: "some title", url: "some url"}
  ...
  describe "update post" do
    ...
    test "redirects when data is valid", %{conn: conn, post: post} do
      ...
      assert html_response(conn, 200) =~ "some updated b"
    end
